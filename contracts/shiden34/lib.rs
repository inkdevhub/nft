...
#[openbrush::implementation(PSP34, PSP34Metadata, Ownable)]
#[openbrush::contract]
pub mod shiden34 {
    use ink::codegen::{
        EmitEvent,
    ...
    impl Shiden34Contract {
        ...
        pub fn new(
            ...
            metadata::InternalImpl::_set_attribute(&mut instance, collection_id.clone(), String::from("name"), name);
            metadata::InternalImpl::_set_attribute(&mut instance, collection_id.clone(), String::from("symbol"), symbol);
            metadata::InternalImpl::_set_attribute(&mut instance, collection_id, String::from("baseUri"), base_uri);
